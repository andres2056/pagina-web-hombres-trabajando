<template>
    <section class="w-full bg-[#9d9d9d]/20 py-20 px-6 lg:px-12">
        ...
        <p class="text-center text-[#5a504f] max-w-3xl mx-auto mb-16">
           Tecnología avanzada para proteger lo que más importa. Instalación profesional y soluciones de monitoreo a tu medida.
        </p>
...
const proyectosConstruccion = [
    {
        ...
        descripcion: 'Sistemas análogos e IP personalizables, desde 1 hasta 16 cámaras.',
        descripcionLarga:
            'Instalamos kits de videovigilancia completos y a medida para tu hogar o negocio. Configuramos el DVR/NVR y te enseñamos a usar la aplicación para que monitorees tu propiedad en tiempo real desde tu celular, desde cualquier lugar y en cualquier momento.',
        image:
    ...
    {
        titulo: 'Cámaras de Seguridad Inteligentes',
        descripcion: 'Tecnología de vanguardia con funciones activas de disuasión y control.',
        descripcionLarga:
            'Instalamos cámaras especializadas con capacidades avanzadas: audio bidireccional para comunicarte, alarma y luz estroboscópica para ahuyentar intrusos, y seguimiento automático con detección de movimiento inteligente. Disuasión proactiva con visión nocturna a color para una identificación clara.',
        image:
            'https://res.cloudinary.com/dughcx6qb/image/upload/v1760062601/vaciado_pisos.jpg',
        facebook: 'https://www.facebook.com/hombrestrabajando',
    },
    {
        titulo: 'VideoVigilancia Remota 24/7',
        descripcion: 'Vigilancia profesional sin contratos complicados. Tranquilidad real.',
        descripcionLarga:
            'Ofrecemos un servicio de monitoreo desde nuestra central. Nuestros expertos vigilan tus cámaras y te alertan inmediatamente ante cualquier evento sospechoso. Seguridad real y transparente, con avisos instantáneos y sin mensualidades exageradas o letra pequeña.',
        image:
